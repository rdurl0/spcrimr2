...
```{r eval = FALSE}
file_name <- "C:/path/to/your/directory/raw_data/seade_pop.csv"
```
...
seade_pop %>%
  ...
  rename(municipio = X1,
         pop_total = X3,
         pop_msc   = X20,
         pop_fem   = X37) -> seade_pop_cities

#devtools::use_data(seade_pop_cities, overwrite = TRUE)
```
...
#
seade_pop_state <- seade_pop_cities %>%
...
#devtools::use_data(seade_pop_state)
```
